                ...
                <input type="hidden" name="categoryId" value="<?= $category['data']['id']; ?>">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" value="<?= $category['data']['name']; ?>" name="name" required>
                        </div>
                        <div class="col-md-12 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <br>
                            <input type="checkbox" <?= $category['data']['status'] == true ? 'checked':''; ?> style="width: 30px;height: 30px;" name="status">
                        </div>
                        <div class="col-md-12 mb-3 text-end">
                            <button type="submit" name="updateCategroy" class="btn btn-primary">Update</button>
                        </div>
                    </div>
                <?php
                } else {
